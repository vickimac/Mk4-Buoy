...
<script src="scripts/velocity_chart.js" type="text/javascript"></script>
 <script src="lib/d3js/d3-v3.js" charset="utf-8"></script>
<script src='https://api.mapbox.com/mapbox.js/v3.0.1/mapbox.js'></script>
<link href='https://api.mapbox.com/mapbox.js/v3.0.1/mapbox.css' rel='stylesheet' />
<center><title>Vectical Velocity - Mk4 Buoy</title></center>
</head>
...
<body class="bodypad">
	...
	<div class="container-fluid" id="wrapper"><!-- begin 1.div container fluid -->
		...
		<div class="container-fluid" id="wrapper"><!-- begin 2.div container fluid -->
			...
			<h1 class="page-title">Vectical Velocity</h1>
        <p id="velocitytxt">Velocity N/A</p>
